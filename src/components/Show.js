...
export const Show = () => {
    ...
    return (
        //Set container to show card to be nested in.
        <section id="shows" className="section bg-light">
            <div class="container">
                <h1 className="test large bg-dark rounded">
                 Upcoming Shows
                </h1>
            </div>
            {/* Grab show info and map through each item */}
            <div className="shows">
             {Data.map((show) => (
                 <ShowCard
                 //Placing each item in card using template of Showcard
                  venue={show.venue}
